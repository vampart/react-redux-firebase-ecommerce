                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p style={{ color: mode === 'dark' ? 'white' : '' }} className="leading-relaxed">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Temporibus vitae nesciunt vero ea tempore voluptate facilis magnam perspiciatis, ad laborum iste, nostrum, atque voluptas architecto blanditiis maiores dolorum! Laboriosam, sapiente?</p>
